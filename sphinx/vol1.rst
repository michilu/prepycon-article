...
座長挨拶
========
座長の寺田(`@terapyon <http://twitter.com/terapyon>`_)です。

PyCon JP 開催意義・目標
-------------------------------

アメリカやヨーロッパをはじめ10カ国以上で開催されている、Python Conference (PyCon)を日本国内でも開こうと有志が集まり、Pythonのユーザが一同に集まれる場所を提供したいと考えています。
「初心者」はもちろんのこと、「海外からの生の声を聞きたい人」や「会社の業務として参加する人」など、幅広いPythonistaが集まれる場所を目指しています。


また、PyCon の目標は下記になります。
...
カンファレンスとしては、セッションを聞くということがメインとなりますが、オフィスアワー(発表者が質問に答えるコーナの設置)や、昼食時間や休憩時の会話の促進、オープンスペースなどの意見交換が出来る場の提供、さらには、翌日の開発イベント(Sprint)を実施するなど、海外のカンファレンスで行われている方法を取り入れ、「出会い系Python (Python meet up)」の実現を目指します。

Pythonユーザ間や開発者とのコミュニケーションを促し、ひとりでも多くの知り合いを作って帰ってもらいたいと思っています。

PyCon mini との関連
--------------------------

国内でPyConを開催する前段階として、イベント開催のノウハウ蓄積するために、1トラック/1日/入場無料で、今年1月末にPyCon mini JPというイベントを行いました。約130名の方にお越しいただきました。このPyCon miniの成功をベースに、規模を拡大(3トラック/海外からのゲストを迎えるなど)して、PyCon JP 2011を開催することになりました。

今後も継続的にPyCon JPを開催できることを願っています。
